      ...
      <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
        <div className="flex-1">
          <h1 className="text-4xl font-black text-slate-900 mb-4 leading-tight">
            Simulacro Tipo ICFES <br />
            <span className="text-blue-600">Alta Complejidad</span>
          </h1>
          <p className="text-gray-500 text-lg">
            Entrena con retroalimentación visual inmediata y explicaciones geométricas paso a paso.
          </p>
        </div>
